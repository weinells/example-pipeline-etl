...
def main() -> None:
    ...
    modem_mtr = pd.read_csv(raw_dir / "src_modem_mtr.csv")

    transformed = modem_mtr.merge(device_map, on="modem_mac", how="inner")
    transformed = transformed[["customer", "modem_mac", "router_mac", "mtr"]]
    ...
    out_path = interim_dir / "trn_modem_mtr.csv"
