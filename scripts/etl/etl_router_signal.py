...
def main() -> None:
    ...
    router_signal = pd.read_csv(raw_dir / "src_router_signal.csv")

    transformed = router_signal.merge(device_map, on="router_mac", how="inner")
    transformed = transformed[["customer", "modem_mac", "router_mac", "router_snr"]]
    ...
    out_path = interim_dir / "trn_router_signal.csv"
